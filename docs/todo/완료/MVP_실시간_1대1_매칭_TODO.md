...
- [x] Entity와 DB 마이그레이션을 기능 단위로 함께 구현
- [x] 핀의 지역구 소속 및 경도·위도 순서 검증
- [x] 채팅 접근자를 매칭 참여자 2명으로 제한
- [x] 중복 대기, 자기 자신 매칭, 한 요청의 중복 사용을 차단
- [x] AI 장애 시 위치·시간 기반 기본 매칭과 식당 검색으로 fallback
