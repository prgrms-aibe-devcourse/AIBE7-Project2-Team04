...
- 컬럼: `questionnaire_version`, `conversation_level`, `meal_pace`, `planning_style`, `novelty_preference`, `ai_analysis_consent`, `completed_at`, `updated_at`
...
- 자유 서술·Spring AI를 사용하는 2차 확장 데이터입니다.
